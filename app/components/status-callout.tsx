...
export function StatusCallout({
  ...
  if (compact) {
    return (
      <div
        role="alert"
        className="app-card flex items-center gap-3 rounded-2xl border border-danger/30 px-3 py-2.5 text-sm text-danger shadow-sm"
      >
  ...
  return (
    <div
      role="alert"
      className="app-card mb-4 flex items-center gap-4 rounded-2xl border border-danger/30 px-4 py-3 text-sm text-foreground shadow-sm sm:gap-5 sm:px-5 sm:py-4"
    >
