...
const en = {
  ...
  archiveEmptyStoriesHint: "Use Add and choose Write a story.",
  archiveEmptyOcs: "No OCs yet",
  archiveEmptyOcsHint: "Use Add and choose Create an OC.",
...
const es: Record<MessageKey, string> = {
  ...
  archiveEmptyStoriesHint: "Usa Añadir y elige Escribir una historia.",
  archiveEmptyOcs: "Aún no hay OC",
  archiveEmptyOcsHint: "Usa Añadir y elige Crear un OC.",
...
const ca: Record<MessageKey, string> = {
  ...
  archiveEmptyStoriesHint: "Fes servir Afegeix i tria Escriu una història.",
  archiveEmptyOcs: "Encara no hi ha OC",
  archiveEmptyOcsHint: "Fes servir Afegeix i tria Crea un OC.",
